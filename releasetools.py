...
def FullOTA_InstallEnd(info):
	...
	info.script.AppendExtra('ifelse(is_substring("L710W", getprop("ro.bootloader")), run_program("/sbin/sh", "-c", "busybox mv /system/lib_spi/libril-qc-qmi-1.so /system/lib/libril-qc-qmi-1.so"));')
	info.script.AppendExtra('ifelse(is_substring("L710W", getprop("ro.bootloader")), run_program("/sbin/sh", "-c", "busybox mv /system/lib_spi/libril.so /system/lib/libril.so"));')
